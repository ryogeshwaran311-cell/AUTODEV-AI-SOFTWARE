...
logger = logging.getLogger("Calci")
...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', f'sqlite:///{os.path.join(base_dir, "calci.db")}')
...
if __name__ == '__main__':
    ...
    app = create_app()
    logger.info(f"Starting Calci Backend on http://{host}:{port}")
